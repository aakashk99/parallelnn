...
__global__ void MatAddScalar(double* a, double* c, int m, int n, double factor) {
...
extern "C" Matrix* addScalar(double factor, Matrix* mat) {
	...
	MatAddScalar<<<dimGrid, dimBlock>>>(d_a, d_c, m, n, factor);
